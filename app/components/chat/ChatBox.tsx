  ...
  return (
    ...
    >
      ...
      <div>
        <ClientOnly>
          {() => (
            <div className={props.isModelSettingsCollapsed ? "hidden" : "mb-2"}>
              <ModelSelector
                ...
                providerList={
                  props.providerList || (PROVIDER_LIST as ProviderInfo[])
                }
      ...
      <FilePreview
        ...
        onRemove={(index) => {
          props.setUploadedFiles?.(
            props.uploadedFiles.filter((_, i) => i !== index),
          );
          props.setImageDataList?.(
            props.imageDataList.filter((_, i) => i !== index),
          );
        }}
      />
      <ClientOnly>
      ...
      <div className="text-xs text-bolt-elements-textTertiary mb-2">
        If you make something cool using this, tag me on{" "}
        <a
          href="https://x.com/KevinKelbie"
          className="text-bolt-elements-textPrimary underline"
          target="_blank"
        ...
        or on{" "}
        <a
          href="https://sovran.id/c673ff0b5f228feb0abb1001882178d4c588bc4e50f857173544b5543b454f81"
          className="text-bolt-elements-textPrimary underline"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <div className="flex justify-between items-center text-sm p-4 pt-2">
          <div className="flex gap-1 items-center">
            ...
            <IconButton
              ...
              onClick={() =>
                props.setIsModelSettingsCollapsed(
                  !props.isModelSettingsCollapsed,
                )
              }
              disabled={!props.providerList || props.providerList.length === 0}
            >
              <div
                className={`i-ph:caret-${props.isModelSettingsCollapsed ? "right" : "down"} text-lg`}
              />
              {props.isModelSettingsCollapsed ? (
          ...
          <ExpoQrModal
            ...
            onClose={() => props.setQrModalOpen(false)}
          />
        </div>
      </div>
    </div>

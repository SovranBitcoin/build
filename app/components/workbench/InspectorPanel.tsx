...
export const InspectorPanel = ({
  ...
  const [activeTab, setActiveTab] = useState<"styles" | "computed" | "box">(
    "styles",
  );
      ...
      <div className="p-3 border-b border-bolt-elements-borderColor">
        <div className="text-sm">
          <div className="font-mono text-blue-500">
            ...
            {selectedElement.id && (
              <span className="text-green-500">#{selectedElement.id}</span>
            )}
      ...
      <div className="p-3 overflow-y-auto max-h-96">
        {activeTab === "styles" && (
          <div className="space-y-2">
            {Object.entries(getRelevantStyles(selectedElement.styles)).map(
              ([prop, value]) => (
